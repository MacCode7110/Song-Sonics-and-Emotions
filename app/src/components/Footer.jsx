  ...
  return (
    <footer className="footer has-background-success-light">
      <div className="content has-text-centered has-text-weight-medium has-text-black is-size-5">
        <strong>Matthew McAlarney</strong> (Web Developer, Data Researcher, Scratch DJ, Rapper) developed <em>Song Sonics and Feelings</em> to understand the relationship between music
