...
input_csv_path = csv_directory / "music_preferences_and_feelings_survey_data_master_cleaned_v4.csv"
output_csv_path = csv_directory / "music_preferences_and_feelings_survey_data_master_cleaned_v5.csv"
