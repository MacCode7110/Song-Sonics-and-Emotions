...
8. V8 [*PCA* Dimensionality Reduction, *Python* Program Execution, Compress 12 multi-dimensional standardized sonic features into 2 static spatial dimensions (`pca_x` and `pca_y`) for *PCA* rendering] -> `pca_matrix.json`
